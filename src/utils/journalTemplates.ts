...
export const JOURNAL_TEMPLATES: JournalTemplate[] = [
  ...
  // Phase 5 Task 5.3: Cell + PRL templates added to cover spec's
  // "Nature / Science / Cell / PRL / ACS" set.
  {
    id: 'cell-single',
    ...
    scientificNotation: false,
    background: 'white',
    // Cell uses a 2-tone palette (red/blue) consistent with Cell Press style
    colorPalette: ['#C0392B', '#2C3E50', '#16A085', '#D35400', '#7F8C8D', '#8E44AD', '#2980B9', '#27AE60'],
  },
  {
    id: 'cell-double',
  ...
  {
    id: 'prl-single',
    name: 'Physical Review Letters (Single Column)',
    widthInches: 3.375,
    heightInches: 2.4,
    dpi: 600,
    fontSize: 7,
    ...
    marginLeft: 32,
    gridVisible: true,
    // PRL style: scientific notation is common
    scientificNotation: true,
    background: 'white',
    // APS recommends black/grey primary colors with selective accent
    colorPalette: ['#000000', '#444444', '#888888', '#B22222', '#1F4E79', '#5B9BD5', '#70AD47', '#FFC000'],
  },
  {
    id: 'prl-double',
    name: 'Physical Review Letters (Double Column)',
    widthInches: 6.75,
    heightInches: 4.0,
    dpi: 600,
    fontSize: 8,
